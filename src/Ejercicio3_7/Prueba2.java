...
import Ejercicio3_6.Estudiante;
...
public class Prueba2 {
    public static void main(String[] args) {
        ...
        Ejercicio3_6.CursoUniversitario curso = new CursoUniversitario();
        ...
        while (true) {
            ...
            switch (opcion) {
                case 1:
                    ...
                    Ejercicio3_6.Estudiante nuevoEstudiante = new Estudiante(nombre, apellidos, codigo, semestre, notaFinal);
                    curso.añadirEstudiante(nuevoEstudiante);
                    break;
                case 2:
